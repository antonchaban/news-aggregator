...
// Source: news-aggregator/pkg/storage (interfaces: Article)
...
func (mr *MockArticleMockRecorder) Create(arg0 interface{}) *gomock.Call {
	...
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockArticle)(nil).Create), arg0)
}
...
func (m *MockArticle) GetByDateInRange(arg0, arg1 time.Time) ([]model.Article, error) {
	m.ctrl.T.Helper()
...
func (m *MockArticle) GetById(arg0 int) (model.Article, error) {
	m.ctrl.T.Helper()
...
func (mr *MockArticleMockRecorder) GetById(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetById", reflect.TypeOf((*MockArticle)(nil).GetById), arg0)
}
